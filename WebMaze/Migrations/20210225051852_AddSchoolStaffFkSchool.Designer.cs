...
namespace WebMaze.Migrations
{
    ...
    [Migration("20210225051852_AddSchoolStaffFkSchool")]
    partial class AddSchoolStaffFkSchool
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMaze.DbStuff.Model.School.SchoolBuilding", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("school_building");
                });

            modelBuilder.Entity("WebMaze.DbStuff.Model.School.SchoolCertificate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("school_certificate");
                });

            modelBuilder.Entity("WebMaze.DbStuff.Model.School.SchoolSchedule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<TimeSpan>("EndHoursMinutes")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("StartHoursMinutes")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("WebMaze.DbStuff.Model.School.SchoolStaff", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("school_staff");
                });

            modelBuilder.Entity("WebMaze.DbStuff.Model.School.SchoolStudent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("WebMaze.DbStuff.Model.School.SchoolSubject", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("WebMaze.DbStuff.Model.School.SchoolBuilding", b =>
                {
                    b.HasOne("WebMaze.DbStuff.Model.Adress", "Address")
                        .WithOne()
                        .HasForeignKey("WebMaze.DbStuff.Model.School.SchoolBuilding", "AddressId")
            ...
            modelBuilder.Entity("WebMaze.DbStuff.Model.School.SchoolCertificate", b =>
                {
                    b.HasOne("WebMaze.DbStuff.Model.UserAccount.Certificate", "Certificate")
                        .WithOne()
                        .HasForeignKey("WebMaze.DbStuff.Model.School.SchoolCertificate", "CertificateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebMaze.DbStuff.Model.CitizenUser", "CitizenUser")
                        .WithOne()
                        .HasForeignKey("WebMaze.DbStuff.Model.School.SchoolCertificate", "CitizenUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebMaze.DbStuff.Model.School.SchoolSchedule", b =>
                {
                    b.HasOne("WebMaze.DbStuff.Model.CitizenUser", "CitizenUser")
                        .WithOne()
                        .HasForeignKey("WebMaze.DbStuff.Model.School.SchoolSchedule", "CitizenUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebMaze.DbStuff.Model.School.SchoolSubject", "SchoolSubject")
                        .WithOne()
                        .HasForeignKey("WebMaze.DbStuff.Model.School.SchoolSchedule", "SubjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebMaze.DbStuff.Model.School.SchoolStaff", b =>
                {
                    b.HasOne("WebMaze.DbStuff.Model.CitizenUser", "CitizenUser")
                        .WithOne()
                        .HasForeignKey("WebMaze.DbStuff.Model.School.SchoolStaff", "CitizenUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebMaze.DbStuff.Model.School.SchoolBuilding", "SchoolBuilding")
                        .WithOne()
                        .HasForeignKey("WebMaze.DbStuff.Model.School.SchoolStaff", "SchoolId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CitizenUser");

                    b.Navigation("SchoolBuilding");
                });
            ...
            modelBuilder.Entity("WebMaze.DbStuff.Model.School.SchoolStudent", b =>
                {
                    b.HasOne("WebMaze.DbStuff.Model.CitizenUser", "CitizenUser")
                        .WithOne()
                        .HasForeignKey("WebMaze.DbStuff.Model.School.SchoolStudent", "CitizenUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebMaze.DbStuff.Model.School.SchoolBuilding", "SchoolBuilding")
                        .WithOne()
                        .HasForeignKey("WebMaze.DbStuff.Model.School.SchoolStudent", "SchoolId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
